...
[:body, :alternative_title, :more_information, :min_value, :max_value,
    ...
    :change_description, :reviewed_at, :twitter, :biography, :email, :gravatar_email, :length, :outline, :outcomes, :audience, :prerequisites, :requirements, :materials, :subtitle, :image].each do |field|
