...
[:body, :alternative_title, :more_information, :min_value, :max_value,
    ...
    :change_description, :reviewed_at, :honorific_prefix, :honorific_suffix, :role, :description, :url, :telephone, :twitter, :linkedin, :github, :email, :length, :outline, :outcomes, :audience, :prerequisites, :requirements, :materials, :subtitle, :location, :salary, :closing_date].each do |field|
